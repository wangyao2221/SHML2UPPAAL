...
/**
 * This is the item provider adapter for a {@link TSHS_Ecore.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TSHS_EcorePackage.Literals.TRANSITION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TSHS_EcorePackage.Literals.TRANSITION__ACTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TSHS_EcorePackage.Literals.TRANSITION__TRIGGEREVENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TSHS_EcorePackage.Literals.TRANSITION__OWNEDGUARD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.TRANSITION__OWNEDGUARD,
				 TSHS_EcoreFactory.eINSTANCE.createTemporalGuard()));

		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.TRANSITION__OWNEDGUARD,
				 TSHS_EcoreFactory.eINSTANCE.createEventGuard()));

		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.TRANSITION__OWNEDGUARD,
				 TSHS_EcoreFactory.eINSTANCE.createEvaluateGuard()));
	}
