...
/**
 * This is the item provider adapter for a {@link TSHS_Ecore.ComTransition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TSHS_EcorePackage.Literals.COM_TRANSITION__CSRC,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TSHS_EcorePackage.Literals.COM_TRANSITION__CTGT,
				 true,
				 false,
				 true,
				 null,
