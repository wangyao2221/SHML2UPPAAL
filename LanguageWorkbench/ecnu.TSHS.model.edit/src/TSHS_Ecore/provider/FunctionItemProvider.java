...
/**
 * This is the item provider adapter for a {@link TSHS_Ecore.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TSHS_EcorePackage.Literals.FUNCTION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TSHS_EcorePackage.Literals.FUNCTION__INDEVARIABLE);
			childrenFeatures.add(TSHS_EcorePackage.Literals.FUNCTION__DEVARIABLE);
			childrenFeatures.add(TSHS_EcorePackage.Literals.FUNCTION__FRIGHT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.FUNCTION__INDEVARIABLE,
				 TSHS_EcoreFactory.eINSTANCE.createIndeVariable()));

		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.FUNCTION__DEVARIABLE,
				 TSHS_EcoreFactory.eINSTANCE.createDeVariable()));

		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.FUNCTION__FRIGHT,
				 TSHS_EcoreFactory.eINSTANCE.createFright()));
	}
