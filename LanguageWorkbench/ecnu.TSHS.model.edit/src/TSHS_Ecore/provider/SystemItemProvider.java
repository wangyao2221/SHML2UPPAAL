...
/**
 * This is the item provider adapter for a {@link TSHS_Ecore.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TSHS_EcorePackage.Literals.SYSTEM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TSHS_EcorePackage.Literals.SYSTEM__TSHSS);
			childrenFeatures.add(TSHS_EcorePackage.Literals.SYSTEM__GLOBALVARIABLES);
			childrenFeatures.add(TSHS_EcorePackage.Literals.SYSTEM__GLOBALCLOCKS);
			childrenFeatures.add(TSHS_EcorePackage.Literals.SYSTEM__GLOBALEVENTS);
		}
	...
	public String getText(Object object) {
		String label = ((TSHS_Ecore.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TSHS_Ecore.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.SYSTEM__TSHSS,
				 TSHS_EcoreFactory.eINSTANCE.createTSHS()));

		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.SYSTEM__GLOBALVARIABLES,
				 TSHS_EcoreFactory.eINSTANCE.createVariable()));

		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.SYSTEM__GLOBALCLOCKS,
				 TSHS_EcoreFactory.eINSTANCE.createClock()));

		newChildDescriptors.add
			(createChildParameter
				(TSHS_EcorePackage.Literals.SYSTEM__GLOBALEVENTS,
